...
$sql = "SELECT id, nome, email FROM usuarios WHERE tipo = 'Professor' ";
if ($search) {
...
<head>
    ...
    <title>Listagem de professors</title>
                ...
                <form method='get' class='mb-3'>
                    <div class='input-group'>
                        ...
                        <div class='input-group-append'>
                            ...
                            <a href='professorAdicionar.php' class='btn btn-success'><i class='bi bi-plus'></i> Adicionar</a>
                        </div>
                    </div>
                </form>
                            ...
                            <tbody>
                                <?php while ($row = $result->fetch_assoc()): ?>
                                    <tr>
                                        ...
                                        <td><?= $row['nome'] ?></td>
                                        <td><?= $row['email'] ?></td>
                                        <td><a href='professorEditar.php?id=<?= $row['id'] ?>' class='btn btn-sm btn-warning'><i
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <form id="deleteForm" method="post" action="professorExcluir.php" style="display: inline;">
